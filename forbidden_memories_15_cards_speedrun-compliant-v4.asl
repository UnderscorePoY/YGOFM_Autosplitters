...
state("duckstation-qt-x64-ReleaseLTCG", "DuckStation") {
    byte duelist_id: 0x8E8068, 0x9B361;
    bool is_defeat: 0x8E8068, 0x9B362;
    byte win_01: 0x8E8068, 0x179A12;
    byte lost_01: 0x8E8068, 0x9B32E;
    byte lost_02: 0x8E8068, 0x1D561D;
    
    byte menu_id_or_something2: 0x8E8068, 0xF0BB8;
    byte menu_transition: 0x8E8068, 0xF0C08;
}   
...
startup {
    ...
    vars.IsRace = (Func<bool>)(() => 
        timer.Run.Offset.ToString().StartsWith("-")
    );  
